    	...
    	<form name="frm" method="post" action="${contextPath }/memRegister.do">
    		...
    		<table class="table table-bordered" style="text-align:center; border:1px solid #dddddd;">
    					...
    					<div class="form-group" style="text-align: center;margin: 0 auto;">
    						<div class="btn-group" data-toggle="buttons">
    							<label class="btn btn-primary active">
    								<input id="memGender" name="memGender" type="radio" autocomplete="off" value="남자" checked="checked"/>남자
    							</label>
    			...
    			<tr>
    				...
    				<td colspan="2"><input id="memEmail" name="memEmail" class="form-control" type="text" maxlength="20" placeholder="이메이를 입력하세요"/></td>
    			</tr>
    			<!-- 권한체크박스 추가 -->
    			<tr>
    				<td style="width:110px;vertical-align:middle;">사용자 권한</td>
    				<td colspan="2">
    					<label><input type="checkbox" name="authList[0].auth" value="ROLE_USER"/> ROLE_USER</label>
    					<label><input type="checkbox" name="authList[1].auth" value="ROLE_MANAGER"/> ROLE_MANAGER</label>
    					<label><input type="checkbox" name="authList[2].auth" value="ROLE_ADMIN"/> ROLE_ADMIN</label>
   					</td>
    			</tr>
    			<tr>
    				<td colspan="3" style="text-align: left;">
    					<span id="passMessage" style="color:red"></span><input onclick="goInsert()" type="button" value="등록" class="btn btn-primary btn-sm pull-right"/>
    				</td>
    			</tr>
    		</table>
    		<!-- 스프링 시큐리티 토큰 -->
