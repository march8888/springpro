      ...
      <security:authorize access="isAnonymous()">
     	...
     	<security:authorize access="isAuthenticated()">
	      <ul class="nav navbar-nav navbar-right">
           ...
           <li><a href="${contextPath }/logout"><span class="glyphicon glyphicon-log-out"></span> 로그아웃</a></li>
			  	 <c:if test="${empty mvo.member.memProfile}">
			  		<li><img class="img-circle" src="${contextPath }/resources/images/person.png" style="width:50px; height: 50px"/>${mvo.member.memName }님
			  	 </c:if>
			  	 <c:if test="${!empty mvo.member.memProfile}">
			  		<li><img class="img-circle" src="${contextPath }/resources/images/${mvo.member.memProfile}" style="width:50px; height: 50px"/>${mvo.member.memName }님
			  	 </c:if>
			  	 (
